...
export const constants = {
  ...
  ACCOUNT_REGISTER_PROSPECT: createSagaAction('ACCOUNT_REGISTER_PROSPECT'),
...
export const actions = {
  ...
  registerProspect: ({ name, email, zipcode }) => ({
    type: constants.ACCOUNT_REGISTER_PROSPECT.ACTION,
    name,
    email,
    zipcode
  }),
...
export default createReducer(initialState, (state, action) => {
  switch (action.type) {
    ...
    case constants.ACCOUNT_LOGIN.FAILED:
      return {
        ...state,
        loggingIn: false
      };
    case constants.ACCOUNT_REGISTER_PROSPECT.ACTION:
      return { ...state, loading: true };
    case constants.ACCOUNT_REGISTER_PROSPECT.SUCCESS:
      return {
        ...state,
        loading: false,
        prospect: action.payload
      };
    case constants.ACCOUNT_REGISTER_PROSPECT.FAILED:
      return {
        ...state,
        loading: false,
